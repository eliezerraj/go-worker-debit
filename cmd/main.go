...
import(
	...
	"github.com/go-worker-debit/internal/infra/configuration"
	...
	"github.com/go-worker-debit/internal/infra/server"
...
var(
	...
	childLogger = log.With().Str("component","go-worker-debit").Str("package", "main").Logger()
)
